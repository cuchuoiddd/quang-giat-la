...
<head>
    ...
    <meta property="og:url" content="https://giatlatoanquoc.com/"/>
    <meta property="og:title" content="{{isset($setting->meta_title) ? $setting->meta_title : '' }}"/>
    <meta property="og:image" content="https://giatlatoanquoc.com{{$setting->logo}}"/>
    <meta property="og:description" content="{{isset($setting->meta_description) ? $setting->meta_description : '' }}"/>
    <link rel="canonical" href="https://giatlatoanquoc.com" />
    {{--    end meta og--}}
                ...
                <ul class="navbar-nav ml-auto mt-2 mt-lg-0 hidden-sm">
                    ...
                    <li class="icon-header">
                        <a target="_blank" href="{{$setting->ios_link}}">
                            <svg aria-hidden="true" focusable="false" data-prefix="fab" data-icon="app-store"
                                 class="svg-inline--fa fa-app-store fa-w-16" role="img"
                                 xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path fill="currentColor"
    ...
    <div class="container">
        <div class="content flex-between">
            <div class="grid-item heading">
                <h1 class="title" style="text-transform: uppercase;">{!!isset($setting->title) ? $setting->title : '' !!}</h1>
                <p class="des">{!!isset($setting->address) ? $setting->address : '' !!}</p>
{{--                <p class="des">Mail: giatlatoanquoc@gmail.com</p>--}}
                <p class="des">Website: {{request()->getHost()}}</p>
            </div>
            <div class="grid-item action-wrapper">
                <div class="hotline">
                    ...
                    <div class="number"><span class="icon"><svg xmlns="http://www.w3.org/2000/svg"
								...
								</svg></span>{!!isset($setting->phone) ? $setting->phone : '' !!}</div>
        ...
        <div class="chat-item">
            ...
            <div class="tawk-to-gv88">
                <div id="widget-btn-tawk_to" class="widget-btn-float-container widget-tooltip">
                    <a href="javascript:void(0);" class="widget-menu-tawk-to"
                       data-action="widget_current_channel = 'tawk_to'; penTawkToPopup();">
                        <span class="button_tap"></span>
                    </a>
