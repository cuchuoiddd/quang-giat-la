...
<section class="product-grid new-product mb50">
    <div class="container">
        <div class="title">
            <h1 class="heading">{{isset($setting->sale_product_heading) ? $setting->sale_product_heading : '' }}</h1>
            <h3 class="subheading">{{isset($setting->sale_product_subheading) ? $setting->sale_product_subheading : '' }}</h3>
        </div>
